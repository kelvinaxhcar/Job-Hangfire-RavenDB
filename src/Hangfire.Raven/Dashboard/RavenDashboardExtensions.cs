    ...
    public static class RavenDashboardExtensions
    {
        ...
        public static IGlobalConfiguration UseRavenDashboard(this IGlobalConfiguration configuration)
        {
            ...
            lock (_lock)
            {
                ...
                DashboardRoutes.Routes.Add("/api/ui5/batch-cancel", ui5ApiDispatcher);
                DashboardRoutes.Routes.Add("/api/ui5/batch/delete", ui5ApiDispatcher);
                DashboardRoutes.Routes.Add("/api/ui5/batch-delete", ui5ApiDispatcher);
                ...
                DashboardRoutes.Routes.Add("/ui5/api/batch-cancel", ui5ApiDispatcher);
                DashboardRoutes.Routes.Add("/ui5/api/batch/delete", ui5ApiDispatcher);
                DashboardRoutes.Routes.Add("/ui5/api/batch-delete", ui5ApiDispatcher);
